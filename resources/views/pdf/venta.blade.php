...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo_nombre.png" alt="incanatoIT" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>SGL Reformas</b><br>Calle Torres, 29 46018, València<br>Telefono:(+34)680 37 71 41<br>Email: info@sglreformas.com
                </p>
            </div>
            <div id="fact">
