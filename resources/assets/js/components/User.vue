                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    ...
                                    <td v-text="persona.localidad"></td>
                                    <td v-text="persona.codigo_postal"></td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="localidad" class="form-control" placeholder="Localidad">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Código Postal</label>
                                    <div class="col-md-9">
                                        <input type="email" v-model="codigo_postal" class="form-control" placeholder="Código Postal">
                                    </div>
                                </div>
                                <div class="form-group row">
